            ...
            <div class="flex flex-col items-center text-center w-5/6 text-white ">
                ...
                <div class="mb-8 flex gap-4">
                    ...
                    <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                        class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transform hover:scale-105"
                        type="button">
                        I'm Professional
                    </button>
